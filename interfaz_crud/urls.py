...
urlpatterns = [
    ...
    path('clientes/<int:pk>/', views.DetalleCliente.as_view(), name='detalle_cliente'),
    ...
    path('cotizaciones/', views.ListaCotizaciones.as_view(), name='lista_cotizaciones'),
    path('cotizaciones/nueva/', views.CrearCotizacion.as_view(), name='crear_cotizacion'),
    path('cotizaciones/<int:pk>/', views.DetalleCotizacion.as_view(), name='detalle_cotizacion'),
    path('cotizaciones/<int:pk>/editar/', views.EditarCotizacion.as_view(), name='editar_cotizacion'),
    path('cotizaciones/<int:pk>/eliminar/', views.EliminarCotizacion.as_view(), name='eliminar_cotizacion'),
]